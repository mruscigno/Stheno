...
export default async function Account(){
  ...
  return <section className="account-page"><header><p className="eyebrow">Account</p><h1>Manage your STHENO.</h1><p>Manage your profile, membership, preferences, and privacy.</p></header><div className="account-card-grid">
    ...
    <section className="account-card"><p className="kicker">Founding member feedback</p><h2>Help improve adaptation.</h2><p>Share private, structured feedback. Publication permissions are separate, optional, and recorded explicitly.</p><Link className="button secondary" href="/app/founding-feedback">Share feedback</Link></section>
