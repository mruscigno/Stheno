...
<script type="application/ld+json" dangerouslySetInnerHTML={{__html:safeJsonLd({"@context":"https://schema.org","@type":"Organization",name:"STHENO Fitness",url:siteUrl,logo:`${siteUrl}/stheno-logo-orange.svg`})}} />
  </main>;
}
