...
export async function GET(
  ...
  const { data } = await supabase
    .from("exercises")
    .select(
      "slug,name,family,movement_pattern,primary_muscles,secondary_muscles,required_equipment,education,caution_tags,fatigue_cost,rep_min,rep_max",
    )
    .eq("slug", slug)
